...
#include "default_dq_mma_multistage.h"
#include "default_dq_mma_pipelined.h"
#include "default_mma_bf16.h"
...
private:
    static constexpr int kAlignmentScale = 128 / sizeof_bits<int8_t>::value;



    // 初始化问题
    
    using Mma = DqMma<int8_t,
                      LayoutA,
                      kAlignmentA,
                      cutlass::int4b_t,
                      LayoutB,
